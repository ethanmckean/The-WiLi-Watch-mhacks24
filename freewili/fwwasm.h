...
// radio
int RadioDataRxCount() WASM_IMPORT("RadioDataRxCount");
int RadioDataRead(unsigned char *pBytesOut, int iLength) WASM_IMPORT("RadioDataRead");
int RadioWrite(unsigned char *pBytesIn, int iLength) WASM_IMPORT("RadioWrite");
